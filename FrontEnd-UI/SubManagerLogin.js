...
import { login } from '../actions/subManagerAuthAction'
import Alert from '../layout/Alert'
import Dashboard from './Dashboard'
// import Signup from './Signup'

const SubManagerLogin = ({ login, isAuthenticated, token, role }) => {
  ...
  if (token && isAuthenticated && role === "submanager") {
    return <Redirect to='/submanagerdashboard' />
  }
    ...
    <BrowserRouter>
      ...
      <div className="container-fluid">
        ...
        <center>
          ...
          <h3 className="center black-text" >Sub Manager Panel</h3>
...
export default connect(mapStateToProps, { login })(SubManagerLogin)
