...
import { register } from '../actions/subManagerAuthAction'
...
//       role:""
//     };
    const SubManageraddrole = ({ register, isAuthenticated,auth,roles,token  }) => {
  ...
  <Route path='/navigation' component={Navigation} />
    ...
    export default connect(mapStateToProps, { register })(SubManageraddrole)
