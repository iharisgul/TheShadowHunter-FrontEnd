...
class ViewScan extends Component {
    constructor(props){
        super(props)
        this.state={
            managers:null,
        ...
        axios({
            method: 'post',
            url: 'http://localhost:5000/api/users/getscanner',//'http://115.186.176.139:5000/api/attacksessions/startattacksession',
            
        })
            .then(response => {
                  this.setState({scanner: response.data.scanner})
                    
            })
            .catch(err => alert(err + 'Could not get Scann result'));
    }
            ...
            <div className='col s12 m8 l9 offset-l2 main' style={{marginLeft:'18%', marginRight:"1%"}}>
              ...
              <div className='row'>
                ...
                >
                  ...
                  <tbody>
        {
            this.state.departments ? this.state.departments.map((fields)=>
            {
                return(
...
export default connect(mapStateToProps)(ViewScan)
