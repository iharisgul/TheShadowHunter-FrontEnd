...
class ViewSubManager extends Component {
    constructor(props){
        super(props)
        this.state={
        ...
        axios({
            method: 'post',
            url: 'http://localhost:5000/api/users/getsubmanagers',//'http://115.186.176.139:5000/api/attacksessions/startattacksession',
            
        })
            .then(response => {
                  this.setState({submanagers: response.data.submanagers})
            ...
            <div className='col s12 m8 l9 offset-l2 main' style={{marginLeft:'18%', marginRight:"1%"}}>
              ...
              <div className='row'>
                ...
                >
                  ...
                  <tbody>
        {
            this.state.submanagers ? this.state.submanagers.map((fields)=>
            {
                return(
...
export default connect(mapStateToProps)(ViewSubManager)
